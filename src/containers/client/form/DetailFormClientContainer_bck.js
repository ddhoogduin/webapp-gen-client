...
import {addInput, getClientFormInputList, removeInput, addInputOption, removeInputOption} from '../../../actions/client/inputClientActions'
import {getForm, uploadForm} from '../../../actions/client/formClientActions'
import DetailFormClient from "../../../components/pages/client/DetailFormClient";
import {
    getFormValues
} from 'redux-form'
